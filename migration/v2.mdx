---
title: migrating from sync v1 to v2
...
If you're reading this, your account has already been migrated from sync v1 to v2.
...
- **Where to log in**: Navigate to the new playground at [https://platform.sync.so](https://platform.sync.so).
...
- **Get familiar**: Take some time to explore the redesigned [v2 playground](https://platform.sync.so) to get comfortable with the new features and layout.
