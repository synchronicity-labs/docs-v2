---
title: lipsync 1.6.0
description: legacy model that is ideal for simple frontal videos.
---

<Note>**model id:** `lipsync-1.6.0`</Note>

LipSync 1.6.0 is our oldest & legacy model in the lip-synchronization series. It is optimized for specific use cases and has some notable characteristics:
