...
1. sign up at the [developer playground](https://platform.sync.so) to create your account.
2. navigate to the [keys](https://platform.sync.so/keys) page and click `create new key`.
